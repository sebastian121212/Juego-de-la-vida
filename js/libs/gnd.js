...
(function (Gnd) {
    var TwoWayBinder = (function () {
        ...
        TwoWayBinder.prototype.createBinding = function (attr, el, viewModel) {
            var attrBinding = this.attrBindings[attr], attrFormatter = this.attrFormatters[attr], obj = viewModel.resolveContext(([
attrBinding[0]            ]));
...
(function (Gnd) {
    var EachBinder = (function () {
        ...
        EachBinder.prototype.bind = function (el, value, viewModel) {
            ...
            var mappings = this.mappings, nextSibling = el.nextSibling, keyPath = Gnd.makeKeypathArray(arr[0]), collection = viewModel.resolveContext(keyPath), itemContextName = arr[1].trim();
            ...
            if(collection instanceof Gnd.Collection) {
                ...
                var attachNode = function (node, nextSibling) {
                    if(nextSibling) {
...
(function (Gnd) {
    var EventBinder = (function () {
        ...
        EventBinder.prototype.parse = function (value) {
            ...
            while(match = Gnd.TwoWayBinder.re.exec(value)) {
...
(function (Gnd) {
    ...
    var ViewModel = (function (_super) {
        ...
        function ViewModel(el, context, formatters, binders) {
            ...
            this.binders = {
                bind: Gnd.TwoWayBinder,
                each: Gnd.EachBinder,
                show: Gnd.ShowBinder,
                'class': Gnd.ClassBinder,
                event: Gnd.EventBinder
            };
